...
bathymetry   = './bathymetry_ar_50v.bin'
hycomSSTFile = './hycom_T_2018-01-02_00.bin'
hycomUFile   = './hycom_U_2018-01-02_00.bin'
hycomVFile   = './hycom_V_2018-01-02_00.bin'
...
ini_sst  = np.reshape(sstRaw,(nZZ,nYY,nXX));
ini_uoce = np.reshape(uoceRaw,(nZZ,nYY,nXX));
ini_voce = np.reshape(voceRaw,(nZZ,nYY,nXX));
ini_deep_ = ini_deep[:,:]
